...
resource "aws_ssm_parameter" "instance_type" {
  name  = "/demo-sido/ec2/instance-type"
  type  = "String"
  value = "t2.micro"
...
resource "aws_ssm_parameter" "allowed_cidr" {
  name  = "/demo-sido/security/allowed-cidr"
  type  = "String"
...
resource "aws_ssm_parameter" "test_instance_type" {
  name  = "/demo-sido/test/ec2/instance-type"
  type  = "String"
  value = "t2.micro"
...
resource "aws_ssm_parameter" "prod_instance_type" {
  name  = "/demo-sido/prod/ec2/instance-type"
  type  = "String"
  value = "t2.small"
